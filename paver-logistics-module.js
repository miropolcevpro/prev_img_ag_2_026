(function(){
  ...
  function renderCollapsed(box, res){
    ...
    box.innerHTML = '' +
      '<button type="button" class="plcCollapsed" data-plc-action="panel-toggle" aria-expanded="false">' +
        '<span class="plcCollapsedMain"><span class="plcCollapsedTitle">Логистика</span><span class="plcCollapsedRow"><span class="plcCollapsedSub">' + esc(sub) + '</span><span class="plcCollapsedBadge">' + esc(badge) + '</span></span></span>' +
  ...
  function renderResult(box, res){
    ...
    box.innerHTML = '' +
      '<button type="button" class="plcCollapsed" data-plc-action="panel-toggle" aria-expanded="true">' +
        '<span class="plcCollapsedMain"><span class="plcCollapsedTitle">Логистика</span><span class="plcCollapsedRow"><span class="plcCollapsedSub">' + esc((v.short_name || v.name || v.id) + ' · ' + sel.trips + ' рейс(ов)') + '</span><span class="plcCollapsedBadge ' + (manual ? 'plcCollapsedBadgeManual' : '') + '">' + (manual ? 'выбрано' : 'авто') + '</span></span></span>' +
        '<span class="plcChevron" aria-hidden="true">⌄</span>' +
