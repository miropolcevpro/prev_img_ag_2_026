(function(){
  ...
  var VERSION = 'paver-logistics-single-module-final-polish-20260611-1';
  ...
  var DEFAULT_RULES = {
    version: 'inline-transport-rules-20260611-final-polish-1',
    enabled: true,
  ...
  function ensureStyle(){
    ...
    style.textContent = [
      ...
      '.plcCollapsedMain{min-width:0;display:flex;flex-direction:column;gap:9px;align-items:flex-start}.plcTitleLine{display:flex;flex-direction:column;align-items:flex-start;gap:7px;min-width:0;width:100%}.plcCollapsedTitle{display:block;font-size:21px;font-weight:950;line-height:1.05;letter-spacing:-.025em;white-space:normal}.plcModeBadge{display:inline-flex;align-items:center;justify-content:center;min-height:28px;border-radius:999px;padding:0 12px;background:rgba(31,107,58,.11);color:#1f6b3a;font-size:12px;font-weight:950;line-height:1.15;white-space:normal;text-align:left;max-width:100%}.plcModeBadgeManual{background:rgba(27,116,255,.12);color:#1b74ff}',
      '.plcSummaryLine{display:flex;flex-direction:column;gap:6px;min-width:0;width:100%}.plcCollapsedSub{display:block;min-width:0;font-size:14px;color:rgba(0,0,0,.66);line-height:1.32;white-space:normal;overflow-wrap:anywhere}.plcTripBlock{display:flex;flex-direction:column;align-items:flex-start;gap:2px;min-width:0}.plcTripLabel{display:block;font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:.02em;color:rgba(0,0,0,.48);line-height:1.1}.plcTripValue{display:block;font-size:15px;font-weight:950;color:rgba(0,0,0,.86);line-height:1.18}.plcCollapsedTripLine{display:block}.plcCollapsedBadge{display:inline-flex;align-items:center;justify-content:center;align-self:flex-start;min-height:32px;border-radius:999px;padding:0 12px;background:rgba(31,107,58,.12);color:#1f6b3a;font-size:13px;font-weight:950;line-height:1;white-space:nowrap}',
      '.plcChevron{width:46px;height:46px;border-radius:999px;border:1px solid rgba(31,107,58,.22);background:#fff;display:grid;place-items:center;color:#1f6b3a;transition:transform .16s ease;justify-self:center;align-self:center;font-size:0;line-height:0;padding:0;box-shadow:0 2px 7px rgba(0,0,0,.035)}.plcChevron:before{content:"";display:block;width:10px;height:10px;border-right:2.4px solid currentColor;border-bottom:2.4px solid currentColor;transform:rotate(45deg);transform-origin:center;margin-top:-4px}.plcBox.isPanelOpen .plcChevron{transform:rotate(180deg)}.plcDivider{height:1px;background:rgba(0,0,0,.07);margin:0 16px 12px}.plcPanel{padding:0 16px 16px;background:linear-gradient(180deg,rgba(31,107,58,.025),rgba(255,255,255,1))}',
  ...
  function renderCollapsed(box, res){
    ...
    var vehicleName = hasData ? (sel.vehicle.short_name || sel.vehicle.name || sel.vehicle.id) : 'транспорт будет подобран после выбора позиции';
  ...
  function renderEmpty(box){
    ...
    box.innerHTML = '' +
      '<button type="button" class="plcCollapsed" data-plc-action="panel-toggle" aria-expanded="true">' +
        '<span class="plcCollapsedMain">' +
          '<span class="plcTitleLine"><span class="plcCollapsedTitle">Логистика</span><span class="plcModeBadge">Рекомендация по транспорту</span></span>' +
          '<span class="plcSummaryLine"><span class="plcCollapsedSub">Расчёт транспорта по поддонам и весу</span><span class="plcTripBlock"><span class="plcTripLabel">Количество рейсов</span><span class="plcTripValue">выберите позицию</span></span><span class="plcCollapsedBadge">готово</span></span>' +
        '</span>' +
        '<span class="plcChevron" aria-hidden="true"></span>' +
