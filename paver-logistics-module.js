(function(){
  ...
  var VERSION = 'paver-logistics-accordion-ui-fix-20260611-1';
  ...
  function ensureStyle(){
    ...
    style.textContent = [
      ...
      '.plcCollapsed{width:100%;border:0;background:transparent;padding:14px 16px;display:grid;grid-template-columns:minmax(0,1fr) auto 44px;align-items:center;gap:12px;cursor:pointer;text-align:left;font:inherit;color:inherit;min-height:78px}.plcCollapsedMain{min-width:0;display:flex;flex-direction:column;gap:5px}.plcCollapsedTitle{display:block;font-size:20px;font-weight:950;line-height:1.1;letter-spacing:-.02em;white-space:normal}.plcCollapsedSub{display:block;font-size:13.5px;color:rgba(0,0,0,.62);line-height:1.28;white-space:normal;overflow-wrap:anywhere}.plcCollapsedBadge{min-width:0;max-width:240px;min-height:38px;border-radius:999px;padding:0 14px;display:inline-flex;align-items:center;justify-content:center;text-align:center;background:rgba(31,107,58,.12);color:#1f6b3a;font-size:13px;font-weight:950;line-height:1.15;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.plcCollapsedBadgeManual{background:rgba(27,116,255,.12);color:#1b74ff}.plcChevron{width:44px;height:44px;border-radius:999px;border:1px solid rgba(31,107,58,.2);background:#fff;display:inline-flex;align-items:center;justify-content:center;font-size:22px;font-weight:900;line-height:1;color:#1f6b3a;transition:transform .16s ease;justify-self:center;align-self:center;flex:0 0 44px}.plcBox.isPanelOpen .plcChevron{transform:rotate(180deg)}.plcPanel{padding:0 16px 16px}.plcDivider{height:1px;background:rgba(0,0,0,.07);margin:0 16px 12px}',
      ...
      '@media(max-width:760px){.plcCollapsed{grid-template-columns:minmax(0,1fr) 44px;grid-template-rows:auto auto;gap:8px 10px;padding:14px 14px;min-height:86px}.plcCollapsedMain{grid-column:1;grid-row:1}.plcCollapsedTitle{font-size:20px}.plcCollapsedSub{font-size:13px}.plcCollapsedBadge{grid-column:1;grid-row:2;justify-self:start;max-width:100%;min-height:32px;padding:0 12px;font-size:13px;white-space:normal;text-align:left}.plcChevron{grid-column:2;grid-row:1 / span 2;align-self:center;justify-self:center;width:44px;height:44px}.plcBox{border-radius:18px}.plcHead{display:block}.plcBadge{display:inline-flex;margin-top:9px}.plcMetrics{grid-template-columns:1fr;gap:7px}.plcMetric{display:flex;justify-content:space-between;gap:12px;align-items:center}.plcMetric b{margin-top:0;font-size:16px;text-align:right}.plcVehicleTop{align-items:flex-start}.plcBarRow{grid-template-columns:62px 1fr 44px}.plcActions{display:grid;grid-template-columns:1fr}.plcBtn{width:100%}.plcOption{grid-template-columns:1fr}.plcOptionTrips{white-space:normal}}@media(max-width:420px){.plcCollapsed{padding:13px 12px}.plcCollapsedTitle{font-size:19px}.plcCollapsedSub{font-size:12.5px}.plcChevron{width:42px;height:42px}.plcCollapsedBadge{font-size:12.5px}}'
    ].join('');
  ...
  function renderCollapsed(box, res){
    ...
    box.innerHTML = '' +
      '<button type="button" class="plcCollapsed" data-plc-action="panel-toggle" aria-expanded="false">' +
        ...
        '<span class="plcCollapsedBadge">' + esc(badge) + '</span><span class="plcChevron" aria-hidden="true">⌄</span>' +
      '</button>';
  }
  ...
  function renderEmpty(box){
    ...
    box.innerHTML = '' +
      '<button type="button" class="plcCollapsed" data-plc-action="panel-toggle" aria-expanded="true">' +
        ...
        '<span class="plcCollapsedBadge">готово</span><span class="plcChevron" aria-hidden="true">⌄</span>' +
  ...
  function renderResult(box, res){
    ...
    box.innerHTML = '' +
      '<button type="button" class="plcCollapsed" data-plc-action="panel-toggle" aria-expanded="true">' +
        ...
        '<span class="plcCollapsedBadge ' + (manual ? 'plcCollapsedBadgeManual' : '') + '">' + (manual ? 'выбрано' : 'авто') + '</span><span class="plcChevron" aria-hidden="true">⌄</span>' +
